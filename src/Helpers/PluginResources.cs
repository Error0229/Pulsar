namespace Loupedeck.Pulsar
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.Pulsar.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.Pulsar.Resources.Resource.txt`.
