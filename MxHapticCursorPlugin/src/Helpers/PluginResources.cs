namespace Loupedeck.MxHapticCursorPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.MxHapticCursorPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.MxHapticCursorPlugin.Resources.Resource.txt`.
